          ...
          child: Row(
            children: [
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        SizedBox(height: 10,),
                        Text("Price: ${widget.productPrice} TK",style: TextStyle(color: Colors.black,),),
                      ],
                    ),
              ...
              widget.isbool == false? Column(
                children: [
                  Text("Available : $stock",style: TextStyle(color: Colors.black87,fontWeight: FontWeight.bold),),
                  SizedBox(height: 10,),
                  Container(
                    height: 25,
                    width: 50,
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                            ...
                            child: Icon(Icons.remove,size: 15,color: Color(0xffd0b84c))
                        ),
                        Text(
                          "$cnt",
                          style: TextStyle(
                        ...
                        InkWell(
                            ...
                            child: Icon(Icons.add,size: 15,color: Color(0xffd0b84c),)
                        ),
                      ],
                    ),
                  ),
              ...
              Expanded(child: Container(
                ...
                child: widget.isbool==false ? Container(
                  ...
                  children: [
                    Text("Quantity: $q",style: TextStyle(color: Colors.black87,fontWeight: FontWeight.bold),),
                    SizedBox(height: 20,),
                    InkWell(
                      onTap: (){

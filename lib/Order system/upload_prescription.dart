    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: Center(
          child: Column(
            children: [
              selectedFile == null ? Image(image: AssetImage('assets/prescription.jpg'),height: 340,width: 340,)
                  :Image.file(
                File(file!.path),
                height: 340,
                width: 340,
              ...
              MaterialButton(
                ...
                child: Text('Choose Prescription',style: TextStyle(color: Colors.white,fontSize: 20),),
              ),
              SizedBox(height: 20,),
              MaterialButton(
                color: Colors.lightBlue,
                ...
                child: Text('Upload Prescription',style: TextStyle(color: Colors.white,fontSize: 20),),
              ),
              SizedBox(height: 40,),
              MaterialButton(
                color: Colors.lightBlue,
                ...
                child: Text('Submit Order',style: TextStyle(color: Colors.white,fontSize: 20),),
              ),
            ],
          ),
        )
